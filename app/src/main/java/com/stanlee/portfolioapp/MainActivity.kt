...
class MainActivity : AppCompatActivity() {
    ...
    fun openEmail(view: View) {
        val emailIntent = Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "stanleyumez@outlook.com", null))
    ...
    fun openTwitter(view: View) {
        val twitterIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/CodeHunta?s=09"))
        startActivity(twitterIntent)
    }
    fun openWhatsapp(view: View) {
        val whatsappIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone=+2348032324739"))
    ...
    fun openLinkedIn(view: View) {
        val linkedinIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.linkedin.com/in/stanley-umezuruike-1417a884"))
        startActivity(linkedinIntent)
    }
    fun openSkype(view: View) {
        val skypeIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://web.skype.com/stanleyumez?call"))
    ...
    fun openAndroid(view: View) {
        val androidIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://developer.android.com/kotlin/"))
    ...
    fun openYoutube(view: View) {
        val ytIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/channel/UCr37EHkT42aJNX9hAzYArdw"))
